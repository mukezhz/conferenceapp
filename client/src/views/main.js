...
exports.roomNameForm = exports.Input = exports.checkTrack = exports.remoteTrackComponent = void 0;
...
function remoteTrackComponent(headerID = "", videoID = "", audioID = "", board) {
    const header = document.createElement("h1");
    header.id = headerID;
...
exports.remoteTrackComponent = remoteTrackComponent;
...
exports.roomNameForm = roomNameForm;
