...
exports.roomService = exports.deleteRoom = exports.createRoom = void 0;
...
function roomService(url) {
    try {
        var svc = new livekit_server_sdk_1.RoomServiceClient(livekitHost, apiKey, apiSecret);
        return svc;
    }
    catch (e) {
...
function createRoom(svc, roomName, timeout, participantno) {
    if (timeout === void 0) { timeout = 5; }
    if (participantno === void 0) { participantno = 10; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, svc.createRoom(opts)];
                case 2:
                    room = _a.sent();
...
function deleteRoom(svc, roomName) {
    svc.deleteRoom(roomName).then(function () {
